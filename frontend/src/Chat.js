...
const s = {
  ...
  headerLogoWrap:{ width:"40px", height:"40px", background:"#fff", borderRadius:"50%", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, boxShadow:"0 3px 12px rgba(0,0,0,0.25)", zIndex:1 },
  headerLogo:{ width:"32px", height:"32px", objectFit:"contain" },
