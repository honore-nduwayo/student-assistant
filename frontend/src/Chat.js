      ...
      <div style={{
        ...
        <div style={s.sidebarInner}>
          ...
          <div style={s.sidebarFooter}>
            <div style={{ color:"rgba(255,255,255,0.4)", fontSize:"10px" }}>Powered by AI</div>
            <div style={{ color:"rgba(255,255,255,0.4)", fontSize:"10px" }}>Official ACity info only</div>
          </div>
        </div>
      </div>
...
const s = {
  page:{ display:"flex", width:"100vw", height:"100dvh", background:"#fafafa", fontFamily:"'Segoe UI',Arial,sans-serif", overflow:"hidden", position:"relative" },
  overlay:{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:299 },
  sidebar:{ width:"220px", background:RED, transition:"transform 0.3s ease", top:0, left:0 },
  sidebarInner:{ width:"220px", height:"100%", display:"flex", flexDirection:"column", padding:"20px 14px", boxSizing:"border-box" },
  sidebarHeader:{ display:"flex", alignItems:"center", gap:"10px", marginBottom:"16px" },
  sidebarLogo:{ width:"36px", height:"36px", objectFit:"contain", background:"#fff", borderRadius:"8px", padding:"3px", flexShrink:0 },
  closeBtn:{ background:"transparent", border:"none", color:"#fff", fontSize:"16px", cursor:"pointer", marginLeft:"auto", padding:"4px" },
  topicLabel:{ color:"rgba(255,255,255,0.5)", fontSize:"10px", fontWeight:"700", textTransform:"uppercase", letterSpacing:"0.5px", marginBottom:"8px" },
  topicBtn:{ display:"block", width:"100%", background:"transparent", border:"none", color:"rgba(255,255,255,0.85)", padding:"9px 10px", borderRadius:"8px", cursor:"pointer", textAlign:"left", fontSize:"13px", fontWeight:"500", marginBottom:"2px" },
  sidebarFooter:{ marginTop:"auto", borderTop:"1px solid rgba(255,255,255,0.2)", paddingTop:"12px" },
  main:{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden", minWidth:0 },
  header:{ background:RED, color:"#fff", padding:"14px 18px", display:"flex", alignItems:"center", gap:"12px", flexShrink:0 },
  hamburger:{ background:"transparent", border:"none", cursor:"pointer", padding:"4px", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, borderRadius:"6px" },
  headerLogo:{ width:"38px", height:"38px", objectFit:"contain", borderRadius:"8px", background:"#fff", padding:"3px", flexShrink:0 },
  headerInfo:{ flex:1, minWidth:0 },
  headerTitle:{ fontWeight:"700", fontSize:"15px", whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" },
  ...
  inputArea:{ display:"flex", padding:"12px 16px", borderTop:"1px solid #ececec", gap:"10px", background:"#fff", alignItems:"flex-end", flexShrink:0 },
