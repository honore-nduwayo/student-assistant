...
const s = {
  ...
  pageWrap:{ width:"100%", maxWidth:"1000px", padding:"20px" },
  shell:{ display:"flex", height:"88vh", background:"#fff", borderRadius:"20px", overflow:"hidden", boxShadow:"0 20px 60px rgba(0,0,0,0.3)" },
