...
const s = {
  page: { minHeight:"100vh", background:"linear-gradient(135deg,#001f5b,#003087)", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'Segoe UI',Arial,sans-serif", padding:"16px" },
  ...
  logoText: { fontWeight:"900", fontSize:"28px", color:"#001f5b" },
  loginTitle: { color:"#001f5b", margin:"0 0 8px", fontSize:"22px" },
  ...
  btn: { background:"linear-gradient(135deg,#003087,#0050c8)", color:"#fff", border:"none", borderRadius:"10px", padding:"12px 24px", fontSize:"15px", cursor:"pointer", width:"100%" },
  ...
  sidebar: { width:"220px", background:"#001f5b", display:"flex", flexDirection:"column", padding:"24px 16px", gap:"4px", flexShrink:0 },
  ...
  heading: { color:"#001f5b", marginTop:0, fontSize:"20px" },
  ...
  editBtn: { background:"#003087", color:"#fff", border:"none", borderRadius:"6px", padding:"6px 14px", cursor:"pointer", fontSize:"12px" },
  ...
  statBox: { background:"linear-gradient(135deg,#003087,#0050c8)", color:"#fff", borderRadius:"16px", padding:"24px", textAlign:"center", marginBottom:"16px" },
  ...
  statFill: { height:"100%", background:"linear-gradient(90deg,#003087,#0050c8)", borderRadius:"20px", transition:"width 0.5s" },
